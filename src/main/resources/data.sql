...
(4, 'Geléia de Banana', 'Geléia caseira de banana', 10.00, 'PT', 'Doces', 4, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsjjy0L3mwvsdlE7G5D-cc-zp1z0T_qpNw_392ZBLmzcqCeS-YEHtSlL7BYFOENNoFiSk&usqp=CAU', 'Geléia caseira de banana, feita com frutas frescas e sem adição de conservantes. Ideal para acompanhar pães, torradas e biscoitos. Ingredientes: banana, açúcar, limão.'),
...
(8, 'Fudge de Banana', 'Fudge cremoso de banana', 18.00, 'PT', 'Doces', 4, 'https://www.inspirationalmomma.com/wp-content/uploads/2022/12/Banana-Fudge-1200x1200-1-720x540.jpg', 'Fudge cremoso de banana, feito com ingredientes naturais e sem conservantes. Delicioso e perfeito para sobremesas e lanches. Ingredientes: banana, chocolate, leite condensado, manteiga.'),
(9, 'Smoothie de Banana', 'Smoothie de banana natural', 15.00, 'LT', 'Doces', 5, 'https://i.panelinha.com.br/i1/228-q-7995-smoothie-de-manga-e-banana-com-iogurte.webp', 'Smoothie de banana natural, preparado com bananas frescas e sem adição de açúcar. Ideal para um lanche saudável e refrescante. Ingredientes: banana, iogurte, mel, leite.'),
